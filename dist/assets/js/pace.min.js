...
(function () {
  ...
  const Z = function (a, b) {
    ...
    for (const d in b) Y.call(b, d) && (a[d] = b[d]);
    return (
  ...
  for (
    ...
    C = function () {
      let a;
      return (a = typeof performance !== "undefined"
            && performance !== null
    ...
    F = function () {
      ...
      return (
        (c = arguments[0]),
        (b = arguments[1]),
        (a = arguments.length >= 3 ? X.call(arguments, 2) : []),
        typeof c[b] === "function" ? c[b].apply(c, a) : c[b]
      );
    },
    v = function () {
      ...
      for (
        b = arguments[0],
        d = arguments.length >= 2 ? X.call(arguments, 1) : [],
        f = 0,
        g = d.length;
        g > f;
        f++
    ...
    g = (function () {
      ...
      return (
        ...
        (a.prototype.trigger = function () {
          ...
          if (
            ((c = arguments[0]),
            (a = arguments.length >= 2 ? X.call(arguments, 1) : []),
  ...
  (b = (function () {
    ...
    return (
      ...
      (a.prototype.render = function () {
        ...
        for (
          a = this.getElement(),
          d = `translate3d(0, ${-this.progress}%, 0)`,
  ...
  y().on("request", function (b) {
    ...
    return (
      ...
      I(g)
        ? void 0
        : j.running || (D.restartOnRequestAfter === !1 && J(f) !== "force")
          ? void 0
          : ((d = arguments),
          (c = D.restartOnRequestAfter || 0),
          typeof c === "boolean" && (c = 0),
          setTimeout(() => {
            let b; let c; let g; let h; let i; let
              k;
            if (
              (b = f === "socket"
                ? e.readyState < 2
    ...
    function a(a) {
      ...
      if (((this.progress = 0), window.ProgressEvent != null)) {
        for (
          ...
          a.addEventListener(
            "progress",
            (a) => (h.progress = a.lengthComputable
        ...
        (a.onreadystatechange = function () {
          let b;
          return (
            (b = a.readyState) === 0 || b === 4
              ? (h.progress = 100)
              : a.readyState === 3 && (h.progress = 50),
    ...
    function a() {
      ...
      (document.onreadystatechange = function () {
        return (
          ...
          typeof a === "function" ? a.apply(null, arguments) : void 0
        );
      });
    }
    return (
  ...
  (m = (function () {
    function a(a) {
      ...
      this.source != null && (this.progress = F(this.source, "progress"));
    }
    return (
      (a.prototype.tick = function (a, b) {
        let c;
        return (
          b == null && (b = F(this.source, "progress")),
          b >= 100 && (this.done = !0),
          b === this.last
  ...
  (j.stop = function () {
    return (
      ...
      r.destroy(),
      (s = !0),
      p != null && (typeof t === "function" && t(p), (p = null)),
      B()
    );
  }),
  (j.restart = function () {
  ...
  (j.go = function () {
    ...
    return (
      ...
      (s = !1),
      (p = G((b, c) => {
        let d; let e; let f; let g; let h; let i; let k; let l; let n; let o; let p; let q; let t; let u; let v; let
          w;
        for (
        ...
        return (
          ...
          r.done() || f || s
            ? (r.update(100),
            j.trigger("done"),
            setTimeout(() => (r.finish(), (j.running = !1), j.trigger("hide")), Math.max(D.ghostTime, Math.max(D.minTime - (C() - a), 0))))
            : c()
        );
      }))
    );
